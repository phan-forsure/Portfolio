  ...
  return (
    <section className="hero m-12 flex flex-wrap content-between">
        <div className='text-4xl font-extralight'>
            ...
            <p className='text-2xl mt-12'>Get in touch <a className='border-b-2 border-b-main hover:bg-blue-800' href='mailto:phantommy38@gmail.com'>phantommy38@gmail.com</a></p>
        </div>
